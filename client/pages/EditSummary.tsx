            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <textarea
                  ...
                  rows={15}
                  className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#7FB5C5] focus:border-[#7FB5C5] resize-vertical min-h-[400px] font-sans text-base leading-relaxed"
                          ...
                          <div className="relative w-20 h-20 mx-auto mb-4">
                            ...
                            >
                              ...
                              <circle
                                ...
                                strokeDashoffset={`${2 * Math.PI * 40 * (1 - (30 - countdown) / 30)}`}
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                              <span className="text-2xl font-bold text-[#4C7B8A]">
                                {countdown}
                              </span>
                            </div>
                          </div>
