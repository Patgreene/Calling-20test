...
export default function RecordingAdmin() {
  ...
  const downloadRecording = async (recordingId: string, fileName: string) => {
    try {
      ...
      setMessage({
        type: "error",
        text: "Download failed. Recording may still be processing.",
      });
    }
  };
    ...
    try {
      ...
      if (!audio) {
        ...
        audio.onerror = (e) => {
          ...
          setMessage({
            type: "error",
            text: "Failed to play audio. The recording may be corrupted.",
          });
          setPlayingAudio(null);
      ...
      setMessage({
        type: "error",
        text: "Failed to play audio. The recording may still be processing or unavailable.",
      });
      setPlayingAudio(null);
      setLoadingAudio(null);
    }
  ...
  const fixStuckRecording = async (recordingId: string) => {
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "success",
          text: result.message || "Recording fixed successfully",
        });
        loadRecordings();
      } else {
        ...
        <div className="relative mb-8">
          <div className="text-center">
            ...
            <p className="text-blue-200 text-lg">
              Interview Recording Management & Monitoring
            </p>
          </div>
                    ...
                    {searchTerm ? (
                      <>
                        <p className="text-white/50">
                          No recordings found for "{searchTerm}"
                        </p>
                      ...
                      <div className="flex items-start gap-4 mb-3">
                        <div className="flex-1 min-w-0">
                              ...
                              <>
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  {recording.transcription && (
                                    <Badge
                                      className={getTranscriptionColor(
                          ...
                          <div className="text-sm text-white/60 space-y-1">
                            ...
                            <div className="flex gap-4">
                              ...
                              {recording.chunks_total &&
                                recording.chunks_uploaded && (
                                  <span>
                                    Chunks: {recording.chunks_uploaded}/
                                    {recording.chunks_total}
                                  </span>
                                )}
                            </div>
                            ...
                            {recording.transcription?.transcript_text ? (
                              <>
                                <textarea
                                  ...
                                  onChange={(e) => {
                                    ...
                                    const newRecordings = recordings.map(
                                      (r) => {
                              ...
                              <div className="w-full h-24 flex flex-col gap-2 p-2">
                                ...
                                <div className="text-xs text-white/40 text-center">
                                  Generate new transcript or refresh to load
                                  existing
                                </div>
                              </div>
                            ) : (
                        ...
                        <div className="flex gap-2">
                          ...
                          {recording.upload_status === "completed" &&
                            recording.verification_status === "verified" && (
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  toggleAudioPlayback(recording.id)
                                }
                          ...
                          {(recording.upload_status === "uploading" ||
                            recording.upload_status === "verifying") && (
                            <Button
                              variant="outline"
                              size="sm"
                        ...
                        <Alert className="border-red-500/50 bg-red-500/10 mt-2">
                          ...
                          <AlertDescription className="text-red-300 text-xs">
                            ...
                            {recording.retry_count > 0 && (
                              <span className="ml-2">
                                (Retried {recording.retry_count} times)
                              </span>
                            )}
                          </AlertDescription>
                        </Alert>
