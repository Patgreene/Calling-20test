...
export default function AICall() {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mb-8">
        {isLoading && (
          <div className="w-[calc(90vw+20px)] sm:w-[560px] h-[420px] sm:h-[420px] border-2 border-dashed border-gray-300 rounded-lg p-4 flex items-center justify-center text-gray-500">
        ...
        <div
          ...
          className={`w-[calc(90vw+20px)] sm:w-[560px] h-[420px] sm:h-[420px] overflow-hidden relative ${isLoading ? "hidden" : ""}`}
          style={{
