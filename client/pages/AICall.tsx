    ...
    >
      <div className="w-full max-w-3xl mx-auto pt-3 sm:pt-6 space-y-1 sm:space-y-3">
        ...
        <div className="relative">
          ...
          <div
            ...
            className={`fixed top-16 sm:top-32 left-1/2 transform -translate-x-1/2 w-[90vw] sm:w-[600px] h-[500px] z-20 ${isLoading ? "hidden" : ""}`}
          />
        </div>
      </div>
      ...
      <div className="absolute bottom-6 right-6">
        <Link to="/edit-summary" state={{ formData }}>
          <Button variant={null} className="!bg-[#FF7A56] hover:!bg-[#f15a33] !text-white font-semibold px-8 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200">
            Next
          </Button>
        </Link>
      </div>
